...
class MainMovieBoxCell: UITableViewCell {
  ...
  private func setupProperties() {
    ...
    movieBoxLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: margin * 2).isActive = true
    ...
    movieBoxPageLabel.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -margin * 2).isActive = true
