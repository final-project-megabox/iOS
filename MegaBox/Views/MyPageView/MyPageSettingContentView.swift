//
//  MyPageSettingContentView.swift
//  MegaBox
//
...
class MyPageSettingContentView: UIView {
  
  weak var delegate: MyPageSettingContentViewDelegate?
  ...
  @objc func didTapLogoutButton(_ sender: UIButton) {
    delegate?.touchUpLogoutButton(sender)
  }
