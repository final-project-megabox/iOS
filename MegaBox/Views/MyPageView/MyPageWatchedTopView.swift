...
class MyPageWatchedTopView: UIView {
  
  var delegate: MyPageWatchedTopViewDelegate?
  ...
  private func setupMyPageWatchedTopView() {
    addSubview(topView)
