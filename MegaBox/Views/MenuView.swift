...
class MenuView: UIView {
  ...
  private func configureCustomTabBar(){
    ...
    menuBar.heightAnchor.constraint(equalToConstant: 130).isActive = true
    ...
    // register
    pageCollectionView.register(ListCell.self, forCellWithReuseIdentifier: ListCell.identifier)
