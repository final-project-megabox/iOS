...
class PaymentView: UIView {
  ...
  @objc private func touchUpPaymentButton() {
    delegate?.touchUpPaymentButton()
  }
  ...
  private func setupProperties() {
    ...
    menuTitleDismissButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: margin).isActive = true
    ...
    okCashbagView.heightAnchor.constraint(equalToConstant: 130).isActive = true
    ...
    authButton.topAnchor.constraint(equalTo: okCashbagExplainLabel.bottomAnchor, constant: margin * 2).isActive = true
    authButton.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -margin).isActive = true
    authButton.widthAnchor.constraint(equalToConstant: UIScreen.main.bounds.width / 5).isActive = true
    authButton.heightAnchor.constraint(equalToConstant: 35).isActive = true
    
    okCashbagView.addSubview(okCashbagFourNumTextField)
    okCashbagFourNumTextField.topAnchor.constraint(equalTo: okCashbagExplainLabel.bottomAnchor, constant: margin * 2).isActive = true
    okCashbagFourNumTextField.trailingAnchor.constraint(equalTo: authButton.leadingAnchor, constant: -margin).isActive = true
    okCashbagFourNumTextField.widthAnchor.constraint(equalToConstant: (UIScreen.main.bounds.width - 60) / 5).isActive = true
    okCashbagFourNumTextField.heightAnchor.constraint(equalToConstant: 35).isActive = true
    
    okCashbagView.addSubview(okCashbagThreeNumTextField)
    okCashbagThreeNumTextField.topAnchor.constraint(equalTo: okCashbagExplainLabel.bottomAnchor, constant: margin * 2).isActive = true
    okCashbagThreeNumTextField.trailingAnchor.constraint(equalTo: okCashbagFourNumTextField.leadingAnchor, constant: -margin / 2).isActive = true
    okCashbagThreeNumTextField.widthAnchor.constraint(equalTo: okCashbagFourNumTextField.widthAnchor).isActive = true
    okCashbagThreeNumTextField.heightAnchor.constraint(equalToConstant: 35).isActive = true
    
    okCashbagView.addSubview(okCashbagTwoNumTextField)
    okCashbagTwoNumTextField.topAnchor.constraint(equalTo: okCashbagExplainLabel.bottomAnchor, constant: margin * 2).isActive = true
    okCashbagTwoNumTextField.trailingAnchor.constraint(equalTo: okCashbagThreeNumTextField.leadingAnchor, constant: -margin / 2).isActive = true
    okCashbagTwoNumTextField.widthAnchor.constraint(equalTo: okCashbagThreeNumTextField.widthAnchor).isActive = true
    okCashbagTwoNumTextField.heightAnchor.constraint(equalToConstant: 35).isActive = true
    
    okCashbagView.addSubview(okCashbagOneNumTextField)
    okCashbagOneNumTextField.topAnchor.constraint(equalTo: okCashbagExplainLabel.bottomAnchor, constant: margin * 2).isActive = true
    okCashbagOneNumTextField.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: margin).isActive = true
    okCashbagOneNumTextField.trailingAnchor.constraint(equalTo: okCashbagTwoNumTextField.leadingAnchor, constant: -margin / 2).isActive = true
    okCashbagOneNumTextField.widthAnchor.constraint(equalTo: okCashbagTwoNumTextField.widthAnchor).isActive = true
    okCashbagOneNumTextField.heightAnchor.constraint(equalToConstant: 35).isActive = true
  ...
  private let paymentButton: UIButton = {
    ...
    button.addTarget(self, action: #selector(touchUpPaymentButton), for: .touchUpInside)
    button.translatesAutoresizingMaskIntoConstraints = false
    return button
  }()
}
